...
// - Makes use the NSDateComponents object
...
// We cannot add two calendar units at the same time,
// so we seperate them and execute two dateByAddingUnit methods
...
// About the NSCalandarOptions and more information about NSCalendar, 
// please refer to
